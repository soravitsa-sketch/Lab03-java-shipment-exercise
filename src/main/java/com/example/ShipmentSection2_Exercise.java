...
//  ชื่อนักศึกษา : นายสรวิชญ์ ศาสนสุพินธุ์
//  รหัสนักศึกษา : 673380294-1
// ╚══════════════════════════════════════════════════════════╝
//
//  โจทย์:
...
class Shipment {
    ...
    public String toString() {
    	return String.format("[%s] %5.1f กก. | %-8s | %8.2f บาท", 
...
class ShippingCompany {
    ...
    public double getTotalCost() {
        ...
        total = shipments.stream().mapToDouble(Shipment -> Shipment.calculateCost()).sum();
        return total;
    }
    ...
    public void printSummary() {
        ...
        System.out.println("----------------------------------------");
        // 2) แสดงยอดรวมตรงนี้
        System.out.printf("  ยอดราคารวมทั้งหมด : %.2f บาท%n", getTotalCost());
        System.out.println("========================================");
    }
}
